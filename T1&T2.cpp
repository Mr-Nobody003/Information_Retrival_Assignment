...
int main(int argc, char** argv) {
    ...
    // Compute tf and tf-idf for each posting
    ...
    for (auto &term : terms) {
        ...
        for (Posting* p = inverted[term].head; p; p = p->next) {
            ...
            fout_task1.setf(std::ios::fixed);
            fout_task1<<setprecision(6);
            fout_task1 << "  [" << p->docid << ", " << p->freq << ", " << p->tf << ", " << p->tfidf << "]\n";
        }
        cout << "\n";
        fout_task1 << "\n";
    }
